      ...
      <ol className='list-decimal w-full flex flex-col gap-5 text-lg px-5'>
         <li className='font-bold'> Mekanisme Utama Permainan
            <ol className='font-normal list-disc pl-5'>
               <li>Permainan ini berbasil <i>Visual Novel</i> di mana Anda akan menghadapi berbagai skenario percakapan dalam budaya Jawa.</li>
               <li>Sistem pilihan telah terletak di setiap titip krusial. Anda akan diberikan beberapa pilihan jawaban. Ketepatan Anda akan menentukan arah cerita dan nasib hubungan Anda dengan tokoh lain dan akhir dari cerita dari <i>Chapter</i> itu sendiri.</li>
         ...
         <li className='font-bold'> Fitur Edukasi & Koleksi
            <ol className='font-normal list-disc pl-5'>
               <li>Selama permainan, Anda dapat mengakses pintasan kamus kosakata <i>(Bausastra Saku)</i> yang merupakan daftar arti kata sulit dalam tingkatan <i>Ngkok, Krama</i> hingga <i>Bahasa Indonesia</i>. Pintasan terletak pada kanan layar.</li>
               ...
               <li>Poin, status, dan <i>badge</i> yang Anda dapatkan dari ketepatan berbahasa dan kelengkapan cerita akan diakumulasikan untuk menentukan posisi Anda dalam <strong>Papan Peringkat</strong> <i>(Leaderboard)</i> bersama dengan pemain lain.</li>
            </ol>
         </li>
         <li className='font-bold'> Aturan & Etika Bermain
            <ol className='font-normal list-disc pl-5'>
               <li><strong>Lathi</strong> bukan hanya sekadar permainan pilihan ganda. Anda diharapkan memahami konteks kepada siapa Anda berbicara (lawan bicara) agar norma kesopanan dan budaya tetap terjaga.</li>
               <li>Perihal integritas data, <strong>Dilarang</strong> menggunakan pihak ketiga untuk memanipulasi skor atau membukan bab <i>(Chapter)</i> secara ilegal. Hargai lawan Anda dan budaya yang sepantasnya mendapatkan kehormatan.</li>
               <li>Sistem melakukan penyimpana otomatis <i>(auto-save)</i> di setiap slide percakapan. Pastikan Anda masuk <i>(Log In)</i> agar data progres Anda tersimpan.</li>
            </ol>
         </li>
         <li className='font-bold'> Kendali Antarmuka <i>(User Interface)</i>
            <ol className='font-normal list-disc pl-5'>
               ...
               <li>Fitur <strong>Auto</strong> membantu proses dialog Anda berjalan otomatis tanpa perlu menekan tombol navigasi <i>Sebelumnya/Lanjut</i>.</li>
