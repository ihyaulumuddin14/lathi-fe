  ...
  return (
    <section id="cta" className="section-wrapper relative z-1 p-[3vw]">
      <header className="flex flex-col gap-6">
        ...
        <h2
          ref={CTATitleRef}
          className="uppercase text-left text-4xl sm:text-6xl md:text-7xl xl:text-8xl leading-9 sm:leading-12 md:leading-14 xl:leading-20 font-bold tracking-tighter overflow-hidden"
        >
      ...
      <main className="w-full h-fit grid sm:grid-cols-2 gap-10 mt-10 items-center">
        <div className="w-full h-fit flex flex-col gap-4">
          ...
          <div className="w-full flex gap-3">
            ...
            <TransitionLink componentType="button-outline" href="/play" transitionType="page">Mainkan</TransitionLink>
          </div>
        </div>
        <div className="cta-image-wrapper w-full h-fit flex justify-center">
          <Image
            ...
            height={500}
            alt="Problem"
            className="problem-image aspect-square object-cover rounded-2xl"
          />
        </div>
      </main>
    </section>
